...
protected:
  ...
  std::vector<std::string> back_left_wheel_name_;
  std::vector<std::string> back_right_wheel_name_;
  std::vector<std::string> front_left_wheel_name_;
  std::vector<std::string> front_right_wheel_name_;
